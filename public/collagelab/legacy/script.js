...
// --- Unified source pool ---
let sourceImages = []; // { name, path, isLocal, originalImg, processedImg, thumbUrl, displayUrl, dither }
let currentSourceName = '';
let currentSourcePath = '';
let currentSourceImg = null; // p5.Image

// --- Brush (260107-style polygon crop + stamp) ---
let overUI = false;
let isBrushing = false;
let brushSize = 140;
let brushOpacity = 70; // 0..100 (match 260107)
let brushScatter = 18;
let brushAmount = 1.0; // density (match 260107 amountSlider)

let brushPts = []; // normalized 0..1
let brushMarkers = [];
let brushPointSvg = null;
let brushPreviewContainer = null;
let brushPreviewImg = null;
let brushStamp = null; // p5.Graphics (cropped polygon)
let isDrawingPermitted = false;
let cursorRing = null;

// --- Effects (260108 params) ---
// Dither is applied per source image (default OFF).
